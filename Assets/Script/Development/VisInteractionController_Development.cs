...
public class VisInteractionController_Development : MonoBehaviour
{
    [SerializeField]
    private PrefabManager prefabManager;
    [SerializeField]
    private DashboardController_Development DC;
    [SerializeField]
    ...
    private void OnTriggerStay(Collider other)
    {
        if (DC.Landmark == ReferenceFrames.Shelves)
        {
            ...
            !other.GetComponent<VisInteractionController_Development>().isGrabbing &&
